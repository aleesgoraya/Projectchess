...
class Knight(ChessPiece):
    ...
    """position is the current position of Knight. row and col given for where the piece should be moved.
    ...
    def check_move(self, position, row, col, board):
        ...
        # Knight only has 8 possible moves. Id doesnt matter if position is empty or taken by enemy.
        # Knight will take the position
        if row == position[0]+2 and col == position[1]+1:
            return True
        elif row == position[0]+2 and col == position[1]-1:
            return True
        elif row == position[0]+1 and col == position[1]+2:
            return True
        elif row == position[0]+1 and col == position[1]-2:
            return True
        elif row == position[0]-1 and col == position[1]+2:
